...
class CartViewModel @Inject constructor() : ViewModel() {
    ...
    fun addToCart(product: Product, quantity: Int,min_Quantity:Int, selectedSize: String?, selectedGrade: String, selectedColor: String,sizeType: String,variationId:Int,itemId:Int): String {
        ...
        return if (existingItem != null) {
            ...
            _cartItems.value = _cartItems.value + CartItem(product, quantity, min_Quantity,sizeType,itemId,variationId,selectedSize?:"", selectedGrade?:"", selectedColor?:"")
